...
<!-- cc:stack — auto-generated by /cc:init, do not edit manually -->
## Stack

**This project uses:** Vue 3 · TypeScript · SCSS/BEM · Bun

@~/.claude-core/skills/core/stack/vue.md
@~/.claude-core/skills/core/stack/typescript.md
@~/.claude-core/skills/core/stack/scss.md
@~/.claude-core/skills/core/stack/bun.md

Before reporting done:
- Run lint and TypeScript check
- Ensure no debug code remains: `console.log`, `dd()`, `dump()`, `var_dump()`
<!-- /cc:stack -->
